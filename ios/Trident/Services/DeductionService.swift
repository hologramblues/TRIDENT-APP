...
"""
    ...
    private func doCall(_ messages: [APIMessage], withTemperature: Bool) async throws -> String {
        var body: [String: Any] = [
            ...
            "max_tokens": 8000, // couvre aussi le raisonnement interne (voir constat au banc 2026-08-12)
