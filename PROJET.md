...
- **App iOS — démarrage sur le déguisement Notes** (2026-08-06, divergence voulue avec la webapp) : l'app native s'ouvre directement sur le faux éditeur Notes (cohérent avec son nom « Notes » sur l'écran d'accueil). On y tape les trois mots, « OK » déduit en silence, appui long révèle le cycle. « ‹ Notes » mène au black mode (saisie MASTER WORD + micro), d'où l'appui long sur MASTER WORD mène aux réglages. La webapp, elle, garde la saisie comme écran par défaut.
